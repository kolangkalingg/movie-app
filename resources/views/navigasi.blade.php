...
<div class="w-full bg-white h-[96px] drop-shadow-lg flex flex-row items-center">
    <div class="w-1/3 pl-5">
        ...
        <a href=""
            class="uppecase text-base mx-5 text-black font-inter hover:text-develobe-500 duration-200 font-bold">TV
            Show</a>
    </div>
    <div class="w-1/3 flex items-center justify-center">
        <a href=""
            class="font-bold text-5xl font-quicksand text-black hover:text-develobe-500 duration-200">MOVIES-21</a>
    </div>
